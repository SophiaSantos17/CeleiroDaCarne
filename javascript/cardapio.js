...
const box01 = document.getElementById('box-option-comidas-01');
const box02 = document.getElementById('box-option-comidas-02');
const box03 = document.getElementById('box-option-comidas-03');
